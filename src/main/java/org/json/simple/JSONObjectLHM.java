...
import org.json.simple.internal.LinkedHashMapJSONObject;

public class JSONObjectLHM extends JSONObject
{
	private static final long serialVersionUID = 1L;
	
	private LinkedHashMapJSONObject jsonObject = null;
	
	public JSONObjectLHM()
	{
		super();
		
		jsonObject = new LinkedHashMapJSONObject();
	}
